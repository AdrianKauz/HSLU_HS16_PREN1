...
# Version:    1.0
#------------------------------------------------------------------------------
# Some functions to draw stuff on the display (Pigpio-Scale)
#------------------------------------------------------------------------------
...
class DisplayTools:
    ...
    def drawBar(self, iBarNumber, iValue, listBuffer):
        # Calculate number of bars
        fBarSize = self.getBarSize(iValue)
